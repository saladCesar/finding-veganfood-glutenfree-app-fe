		...
		<>
			<div className="container">
				<div className="style education col">
							...
							<div className="row">
								<div className="col">
									...
									<p>
										...
										environmental reasons — or a combination of the three. Instead, they eat various
										plant foods, including fruits, vegetables, whole grains, legumes, nuts, seeds,
					...
					<div className="row">
						<div className="col">
							<h4>Gluten-free: What does that mean?</h4>
							<p className="my-2">
							...
							<p>
								...
								their body mounts an immune response that attacks the small intestine. These attacks
								lead to damage on the villi, small fingerlike projections that line the small intestine,
								that promote nutrient absorption. When the villi get damaged, nutrients cannot be
								absorbed properly into the body. Celiac disease is hereditary, meaning that it runs in
